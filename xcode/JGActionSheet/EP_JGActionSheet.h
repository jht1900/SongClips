...
/**
 ...
 @sa JGActionSheet.
 */
@interface EP_JGActionSheetSection : UIView
...
@class EP_JGActionSheet;

/**
 The delegate for JGActionSheet.
 @sa JGActionSheet.
 */
@protocol EP_JGActionSheetDelegate <NSObject>
 ...
 */
- (void)actionSheetWillPresent:(EP_JGActionSheet *)actionSheet;

/**
 Called after the action sheet did present. (Optional)
 */
- (void)actionSheetDidPresent:(EP_JGActionSheet *)actionSheet;

/**
 Called before the action sheet will dismiss. (Optional)
 */
- (void)actionSheetWillDismiss:(EP_JGActionSheet *)actionSheet;

/**
 Called after the action sheet did present. (Optional)
 */
- (void)actionSheetDidDismiss:(EP_JGActionSheet *)actionSheet;
 ...
 */
- (void)actionSheet:(EP_JGActionSheet *)actionSheet pressedButtonAtIndexPath:(NSIndexPath *)indexPath;
 ...
 */
@interface EP_JGActionSheet : UIView
 ...
 */
@property (nonatomic, weak) id <EP_JGActionSheetDelegate> delegate;
...
/**
 ...
 @Note Unlike UIActionSheet, JGActionSheet does not automatically dismiss when a button is pressed. You need to manually call @c dismissAnimated: to dismiss the action sheet.
 */
@property (nonatomic, copy) void (^buttonPressedBlock)(EP_JGActionSheet *actionSheet, NSIndexPath *indexPath);
 ...
 */
@property (nonatomic, copy) void (^outsidePressBlock)(EP_JGActionSheet *sheet);
